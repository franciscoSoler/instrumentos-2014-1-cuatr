...
\subsection{Introducción teórica}
	...
	\begin{figure}[!htb]
		\centering
		\includegraphics[width=8cm]{Imagenes/qmetro.png}
	...
	con respecot al LO es anternadamente conectada a la tierra. Por lo tanto, la
...
\section{Desarrollo}
	...
	\todo{bla}
		...
		\todo{traducir}
		\indent La eficiencia del mixer se mide por la conversion loss, es la 
		relación entre la señal de entrada en el puerto RF con respecto a la 
		salida, puerto IF.
