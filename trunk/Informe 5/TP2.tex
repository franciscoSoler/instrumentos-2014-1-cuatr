...
\section{Introducci\'on}
	...
	\ref{diagramadebloques}. En la Figura se puede observar que la se\~nal de 
	entrada pasa inicialmente por un atenuador y por un filtro pasabajos (cuyo 
	uso determina sin ambig\"uedad el rango de frecuencias con las que se opera,
	aunque si se lo elimina permite extender el rango de frecuencias del 
	analizador). Luego pasa a un multiplicador donde se multiplica con la 
...
\indent Para llevar a cabo las mediciones, se utilizan los siguientes
		...
		%'No se si poner aca incerteza, creo que es m�s importante lo de abajo 
