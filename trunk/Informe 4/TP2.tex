...
% TODO 
	...
	\subsection{Mediciones con el impedanc\'imetro}
		...
		para ello, se colocó directamente el capacitor en la punta del
		impedancímetro. Como el equivalente del mismo es un circuito RLC serie,
		como se muestra en la imagen \ref{imagenCapacitor} 
		\todo[inline]{cambiarNombre y poner el rlc serie}
		...
		realizando los cálculos de las ecauciones \ref{unaEcuacion}se calcularon los
		valores de los componentes del modelo de la capacidad. \\
