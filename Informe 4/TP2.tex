...
% TODO 
	...
	\subsection{Mediciones con el impedanc\'imetro}
		...
		$$\Delta R=\pm 4\%\cdot R_{fe}\pm(\frac{f}{30~MHz}+\frac{R}{25~k\Omega})\%\cdot R_{med}$$
		...
		\\
		\indent la tabla \ref{unaTab} \todo[inline]{corregir el nombre de la 
		referencia y en la tabla igual} muestra los valores medidos con sus 
		respectivas incertidumbres. 
		\indent Para determinar la incertidumbre de la medición 
		\todo[inline]{buscar en manual las incertidumbres de la medición}
		...
		\indent una conclusión
		\todo[inline]{agregar algo sobre lo obtenido}
